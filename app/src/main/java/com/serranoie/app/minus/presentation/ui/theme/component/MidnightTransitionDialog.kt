...
fun MidnightTransitionDialog(
    ...
    val formattedBudget = currencyFormat.format(totalBudget)
    ...
    Dialog(onDismissRequest = onDismiss) {
        Card(
            ...
            Column(
                ...
                // Period dates
                Text(
                    text = "${periodStartDate.dayOfMonth} ${getMonthName(periodStartDate.monthValue)} - ${periodEndDate.dayOfMonth} ${getMonthName(periodEndDate.monthValue)}",
                ...
                OutlinedButton(
                    ...
                    colors = ButtonDefaults.outlinedButtonColors(
                        contentColor = colorOnEditor.copy(alpha = 0.6f)
                    )
                ) {
                    Text(
                        text = "Mas tarde",
...
private fun SummaryCard(
    ...
    valueColor: androidx.compose.ui.graphics.Color = colorOnEditor
) {
    Card(
        modifier = modifier,
        colors = CardDefaults.cardColors(
