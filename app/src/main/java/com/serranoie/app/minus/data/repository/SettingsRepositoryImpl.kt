...
private val EARLY_FINISH_ORIGINAL_END_DATE = longPreferencesKey(EARLY_FINISH_ORIGINAL_END_DATE_KEY_NAME)
...
class SettingsRepositoryImpl @Inject constructor(
    ...
    override fun observeSettings(): Flow<UserSettings> {
        return context.settingsDataStore.data.map { preferences ->
            UserSettings(
                ...
                notificationHour = preferences[NOTIFICATION_HOUR] ?: UserSettings.DEFAULT_NOTIFICATION_HOUR,
                notificationMinute = preferences[NOTIFICATION_MINUTE] ?: UserSettings.DEFAULT_NOTIFICATION_MINUTE,
                themeMode = preferences[THEME_MODE]?.toThemeMode() ?: ThemeMode.SYSTEM,
                typographyMode = preferences[TYPOGRAPHY_MODE]?.toTypographyMode() ?: TypographyMode.EXPRESSIVE,
    ...
    override suspend fun setEarlyFinishActive(active: Boolean, actualDate: Long, originalEndDate: Long) {
        context.settingsDataStore.edit { preferences ->
