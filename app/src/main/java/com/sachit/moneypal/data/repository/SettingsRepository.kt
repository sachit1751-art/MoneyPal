...
interface SettingsRepository {
    ...
    suspend fun setAppColorScheme(colorScheme: com.sachit.moneypal.domain.model.AppColorScheme)
    ...
    suspend fun setPeriodMappingMode(mode: com.sachit.moneypal.domain.model.PeriodMappingMode)

    suspend fun setFirstLaunchTutorialStage(stage: com.sachit.moneypal.domain.model.FirstLaunchTutorialStage)

    suspend fun setRecurrentPaymentsViewMode(mode: com.sachit.moneypal.presentation.ui.history.RecurrentPaymentsViewMode)
    ...
    suspend fun getPendingRollover(): Pair<BigDecimal, com.sachit.moneypal.domain.model.RemainingBudgetStrategy?>
