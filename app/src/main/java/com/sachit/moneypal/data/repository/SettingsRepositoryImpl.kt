...
import com.sachit.moneypal.domain.time.CURRENT_PERIOD_ROLLOVER_AMOUNT_KEY_NAME
import com.sachit.moneypal.domain.time.CURRENT_PERIOD_ROLLOVER_CARRY_FORWARD_KEY_NAME
import com.sachit.moneypal.domain.time.PENDING_ROLLOVER_AMOUNT_KEY_NAME
import com.sachit.moneypal.domain.time.PENDING_ROLLOVER_STRATEGY_KEY_NAME
...
class SettingsRepositoryImpl @Inject constructor(
    ...
    override suspend fun setAppColorScheme(colorScheme: com.sachit.moneypal.domain.model.AppColorScheme) {
        dataStore.edit { preferences ->
    ...
    private fun String.toAppColorScheme(): com.sachit.moneypal.domain.model.AppColorScheme {
        return try {
            com.sachit.moneypal.domain.model.AppColorScheme.valueOf(this)
        } catch (_: Exception) {
            com.sachit.moneypal.domain.model.AppColorScheme.BRAND
        }
    }
