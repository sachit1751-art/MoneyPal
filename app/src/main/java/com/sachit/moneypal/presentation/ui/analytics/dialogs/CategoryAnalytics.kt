...
package com.sachit.moneypal.presentation.ui.analytics.dialogs
...
import com.sachit.moneypal.presentation.ui.theme.component.PaddedListItem
...
import com.sachit.moneypal.presentation.ui.theme.component.charts.DetailedChart
...
fun CategoryAnalytics(
    ...
    Column(
        ...
        Column(
            ...
            Text(
                modifier = Modifier.padding(horizontal = 16.dp).testTag("CategoryAnalyticsTitle"),
