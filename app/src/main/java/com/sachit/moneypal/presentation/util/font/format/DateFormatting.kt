package com.sachit.moneypal.presentation.util.font.format
...
fun countDays(toDate: Date, fromDate: Date): Int {
    ...
    logcat("DateFormatting - SACHIT") { "countDays: fromDate=$fromDate (rounded=$fromDateRound, daysFrom=$daysFrom), toDate=$toDate (rounded=$toDateRound, daysTo=$daysTo), result=$result" }
    return result
}
