...
class DetailedChartScreenshotTest {
        ...
        paparazzi.snapshot {
            MinusTheme {
                Surface(modifier = Modifier.fillMaxWidth()) {
                    DetailedChart(
                        spends = listOf(
                            sampleTransaction(id = 1L, amount = "100.00", daysAgo = 7, categoryId = 1L),
                            sampleTransaction(id = 2L, amount = "60.00", daysAgo = 5, categoryId = 2L),
                            sampleTransaction(id = 3L, amount = "180.00", daysAgo = 3, categoryId = 1L),
                            sampleTransaction(id = 4L, amount = "75.00", daysAgo = 0, categoryId = null),
                        ),
                        categories = categories,
                        onPointClick = {},
                        forcedTouchPosition = Offset(280f, 150f),
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(250.dp),
                    )
    ...
    @Test
    fun detailedChart_selectedDate() {
        Locale.setDefault(Locale.US)
        val categories = listOf(
            Category(id = 1L, name = "Groceries"),
            Category(id = 2L, name = "Transport"),
            ...
            MinusTheme {
                Surface(modifier = Modifier.fillMaxWidth()) {
                    DetailedChart(
                        ...
                        categories = categories,
                        selectedDate = LocalDate.of(2026, 1, 15).minusDays(5),
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(250.dp),
                    )
