package com.sachit.moneypal.presentation.ui.editor.sheets.split
...
class DynamicAllocationsTest {
    ...
    fun `forPeriod returns the matching allocation`() {
        ...
        assertThat(alloc.forPeriod(com.sachit.moneypal.domain.model.BudgetPeriod.DAILY))
            .isEqualTo(alloc.dailyAllocation)
        assertThat(alloc.forPeriod(com.sachit.moneypal.domain.model.BudgetPeriod.WEEKLY))
            .isEqualTo(alloc.weeklyAllocation)
        assertThat(alloc.forPeriod(com.sachit.moneypal.domain.model.BudgetPeriod.BIWEEKLY))
            .isEqualTo(alloc.biweeklyAllocation)
        assertThat(alloc.forPeriod(com.sachit.moneypal.domain.model.BudgetPeriod.MONTHLY))
